...
parser = argparse.ArgumentParser(description='GongzhuAI: Project for COMP5801')

# General Settings
parser.add_argument('--xpid', default='gongzhuai',
                    help='Experiment id (default: gongzhuai)')
...
parser.add_argument('--savedir', default='gongzhuai_checkpoints',
...
parser.add_argument('--batch_size', default=37, type=int,
